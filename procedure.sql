...
-- Procedure para obter os alunos por nome
DELIMITER $$
...
-- Procedure para obter os alunos com média >= 10
DELIMITER $$
...
-- Procedure para obter os professores por nome
DELIMITER $$
...
-- Procedure para obter as disciplinas por nome
DELIMITER $$
